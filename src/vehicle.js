// Decide Price of Vehicle from level 3
const VehicleConfig = [
	{
		level: 1,
...
class Vehicle {
	constructor(level) {
		...
		this.id = 'V#' + Date.now().toString(36);
		...
		const maxPrice = choices[selected].maxPrice;
		const minPrice = choices[selected].minPrice;
